...
var config = {
  ...
  site_title: 'Pando Enterprise Release Documentation',

  // The base URL of your site (can use %base_url% in Markdown files)
  base_url: '',

  // Used for the "Get in touch" page footer link
  support_email: 'smolen@pageflex.com',
  ...
  home_meta : {
    title       : 'Pando Enterprise Release Documents',
    description : 'Release Documentation for Pando Enterprise Components'
  },
